...
onMounted(() => {
  const foundPost = postService.getPost(postId);
  if (!foundPost) {
...
<template>
  <main v-if="post" class="w-full min-h-screen bg-gray-100 pt-24 py-10 px-4">
      ...
      <div class="p-6">
        ...
        <div class="border-t pt-4 flex justify-between items-center">
          <div class="text-sm text-gray-600">
            <p class="font-semibold">Posted by: {{ post.userId }}</p>
